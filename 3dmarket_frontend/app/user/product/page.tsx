...
const MenuPage = async ({ searchParams }: { searchParams: { [key: string]: string | string[] | undefined } }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto py-8 px-4 sm:px-8 lg:px-12">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-blue-900 via-blue-800 to-blue-700 rounded-2xl overflow-hidden mb-10 shadow-2xl">
        ...
        <div className="relative z-10 px-8 py-12 flex flex-col md:flex-row items-center justify-between">
          <div className="mb-6 md:mb-0">
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-2">3D Asset Collection</h1>
            <p className="text-blue-100 max-w-lg">
              Discover and explore premium 3D assets. Find the perfect model for your next project or collection.
            </p>
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
        <h2 className="text-2xl font-bold text-gray-900 mb-8">All 3D Assets</h2>
              ...
              <form action="/user/product" method="GET">
                ...
                <div className="relative w-full">
                  ...
                  <input
                    ...
                    placeholder="Search 3D assets by name, category..."
                  />
                  {search && (
                    <Link
        ...
        {menu.length === 0 ? (
          <div className="bg-white rounded-xl p-8 shadow-md text-center scale-in">
            <div className="max-w-md mx-auto">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">No 3D Assets Found</h3>
              <p className="text-gray-600 mb-6">
                {search || classFilter !== "all"
                  ? "No 3D assets match your search criteria. Try adjusting your filters."
                  : "Your 3D asset collection is empty. Add your first 3D asset to get started."}
              </p>
            </div>
          </div>
        ) : (
